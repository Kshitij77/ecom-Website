...
<body style="padding-top: 50px;">
    ...
    <div class="container">
        <div class="jumbotron home-spacer" id="products-jumbotron" style="font-family: 'Sofia'">
            <center>
                <h1><b>Welcome to our Digital Store</b></h1>
                <p style="font-family: 'Poppins'">We have the best Electronics items from Biggest Brands for you. No need to hunt around, we have all in one place.</p>
            </center>
        </div>
        <hr>
        <br>
                ...
                <div class="panel-group">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading color">
                            <center>
                                <h3 style="color:orange;font-family: 'Sansita Swashed'">Categories</h3>
                            </center>
                            <div class="panel-body">
                                ...
                                ?>
                                    <a href="category_details.php?id=<?php echo $r["category_id"]; ?>">
